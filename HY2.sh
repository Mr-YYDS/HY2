...
inst_site(){
    read -rp "请输入 Hysteria 2 的伪装网站地址 （去除https://） [默认环球资源]：" proxysite
    [[ -z $proxysite ]] && proxysite="www.globalsources.com"
...
EOF
    ...
    url="hysteria2://$auth_pwd@$last_ip:$last_port/?insecure=1&sni=$hy_domain#YYDS"
